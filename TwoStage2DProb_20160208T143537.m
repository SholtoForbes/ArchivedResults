...
bounds.lower.states = [VL ; vL*sin(deg2rad(5)); thetaL; mfuelL-3000]; % FOR v_V TESTING
bounds.upper.states = [VU ; vU*sin(deg2rad(5)); thetaU; mfuelU];
