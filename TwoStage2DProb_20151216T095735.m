...
copyfile('primal',sprintf('../ArchivedResults/primal_%s',datestr(now,30)))
copyfile('dual',sprintf('../ArchivedResults/dual_%s',datestr(now,30)))
copyfile('TwoStage2DProb.m',sprintf('../ArchivedResults/TwoStage2DProb_%s.m',datestr(now,30)))
copyfile('TwoStage2DCost.m',sprintf('../ArchivedResults/TwoStage2DCost_%s.m',datestr(now,30)))
