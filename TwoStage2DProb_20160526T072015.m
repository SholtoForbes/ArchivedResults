...
guess.states(1,:) = [interp1(Atmosphere(:,4),Atmosphere(:,1),2*45000/v0^2) ,34900];
...
% guess.states(3,:) = [deg2rad(1.8),atan((Vf-V0)/(Hf-H0))]; %for 50kPa
% limited
guess.states(3,:) = [deg2rad(1.9),atan((Vf-V0)/(Hf-H0))]; 
end
