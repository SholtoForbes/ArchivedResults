...
if V(end) > 40000;
ThirdStagePayloadMass = gaussmf(V(end),[10000 40000])*thirdstagemanipulation(ThirdStageData,40000, rad2deg(theta(end)), v(end));
else
ThirdStagePayloadMass = thirdstagemanipulation(ThirdStageData,V(end), rad2deg(theta(end)), v(end));
end
